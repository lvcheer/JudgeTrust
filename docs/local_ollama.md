...
disabled and temperature and seed fixed to zero. Ollama receives a full JSON
Schema with enum and numeric constraints, and the returned text is still
checked independently by JudgeTrust's strict result parser.
